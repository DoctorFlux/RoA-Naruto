...
set_hitbox_value(AT_DTILT, 1, HG_HITBOX_Y, -74);
...
set_hitbox_value(AT_DTILT, 2, HG_HITBOX_X, 31);
...
set_hitbox_value(AT_DTILT, 2, HG_ANGLE, 290);
...
set_hitbox_value(AT_DTILT, 2, HG_DRIFT_MULTIPLIER, 1);
set_hitbox_value(AT_DTILT, 2, HG_SDI_MULTIPLIER, 1);
...
set_hitbox_value(AT_DTILT, 3, HG_DRIFT_MULTIPLIER, 1);
set_hitbox_value(AT_DTILT, 3, HG_SDI_MULTIPLIER, 1);
