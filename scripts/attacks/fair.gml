...
set_window_value(AT_FAIR, 4, AG_WINDOW_LENGTH, 23);
...
set_hitbox_value(AT_FAIR, 1, HG_HEIGHT, 67);
...
set_hitbox_value(AT_FAIR, 2, HG_WIDTH, 15);
set_hitbox_value(AT_FAIR, 2, HG_HEIGHT, 15);
...
set_hitbox_value(AT_FAIR, 3, HG_VISUAL_EFFECT_Y_OFFSET, 5);
...
set_hitbox_value(AT_FAIR, 4, HG_HITBOX_Y, -05);
set_hitbox_value(AT_FAIR, 4, HG_WIDTH, 15);
set_hitbox_value(AT_FAIR, 4, HG_HEIGHT, 15);
...
set_hitbox_value(AT_FAIR, 4, HG_KNOCKBACK_SCALING, 0.9);
set_hitbox_value(AT_FAIR, 4, HG_BASE_HITPAUSE, 10);
set_hitbox_value(AT_FAIR, 4, HG_HITPAUSE_SCALING, 0.25);
...
set_hitbox_value(AT_FAIR, 4, HG_IGNORES_PROJECTILES, 0);
