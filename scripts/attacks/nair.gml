...
set_window_value(AT_NAIR, 3, AG_WINDOW_LENGTH, 23);
...
set_window_value(AT_NAIR, 4, AG_WINDOW_HAS_WHIFFLAG, 6);
...
set_hitbox_value(AT_NAIR, 1, HG_LIFETIME, 26);
...
set_hitbox_value(AT_NAIR, 2, HG_LIFETIME, 26);
